...
class GameHandler:
    ...
    def __init__(self, mac_mode=False, window_pos=(100, 100), frames_per_second=60, scale=200):
    ...
    def play_eight_ball(self, shot_decider: Callable[[ff.TableState], ff.ShotParams]):
        game_state: ff.GameState = ff.GameState.RackedState(ff.GT_EIGHTBALL)
        table_state: ff.TableState = game_state.tableState()
        self.play_game_from_table_state(table_state, shot_decider)
